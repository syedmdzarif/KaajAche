...
<body>
	<form action="worker_signupcheck.php" method="post">
		<h2>Signup as a Worker</h2>
		...
		<?php if(isset($_GET['bankAcc'])) { ?>
			<input type="text" name="bankAcc" placeholder="Bank Account Number" value="<?php echo $_GET['bankAcc']; ?>" required><br>
		<?php } else { ?>
			<input type="text" name="bankAcc" placeholder="Bank Account Number" required><br>
		<?php } ?>


		<button type="submit">Sign Up</button>
		<a href="worker_login.php" target="_blank">Already have an account?</a>
